					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Modulo Empresa<small></small>
									</h2>
									<div class="clearfix"></div>
								</div>
								<div class="x_content">
									<!-- Button trigger modal -->
									<a href="../empresa/configuraciongeneral">
									<button type="button" class="btn btn-primary"
									id="btningempresa">Crear Empresa</button>
									</a>
<!-- 									<br/> -->
							<div class="row">
...
<!-- 					                                                        <legend>Filtros de Empresa</legend> -->
					                                                        ...
					                                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
					                                                            <div class="col-md-3 col-sm-6 col-xs-12 form-group">
					                                                                ...
					                                                                <input type="text" name="frmEmpFiltroRazSocial" id="frmEmpFiltroRazSocial" class="form-control input-sm filter-single" value="" maxlength="100">
					                                                            </div>
					                                                            <div class="col-md-3 col-sm-6 col-xs-12 form-group">
					                                                            ...
					                                                            <div class="col-md-3 col-sm-6 col-xs-12 form-group">
					                                                                ...
					                                                                <select class="form-control filter-single input-sm select2-single" id="frmEmpFiltroEstado" name="frmEmpFiltroEstado"/>
...
<!-- 						</div> -->
		...
		<script src="<c:url value='../resources/v1/EmpresaController.js'/>"
