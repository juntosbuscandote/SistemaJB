...
<body class="nav-md">
					...
					<div class="row" id="modalCrearEmpresa">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
										<input type="hidden"  id="emprVdoctype" value="${emprVdoctype}" />
										<input type="hidden"  id="repLegalVTipoDoc" value="${repLegalVTipoDoc}" />
										<input type="hidden"  id="fProcess" value="${fProcess}" />
										<input type="hidden"  id="emprPais" value="${emprPais}" />
										<input type="hidden"  id="emprGC" value="${emprGC}" />
										<input type="hidden"  id="emprLocalidad" value="${emprLocalidad}" />
										<input type="hidden"  id="emprDomici" value="${emprDomici}" />
										
										<input type="hidden"  id="repPais" value="${repPais}" />
										<input type="hidden"  id="repLocalidad" value="${repLocalidad}" />
										<input type="hidden"  id="repDomici" value="${repDomici}" />
	...
	<script type="text/javascript">
		$(document).on('ready', function() {
			var empresaproccess = new EmpresaProccess();
			empresaproccess.init();       
		});
	</script>
</body>
</html>