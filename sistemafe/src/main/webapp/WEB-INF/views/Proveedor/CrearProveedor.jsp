                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <input type="hidden"  id="fProcessProveedor" value="${fProcessProveedor}" />
<%--                                                        <%@include file="../../template/Proveedor/ConfiguracionProveedor.jsp"%> --%>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                                                    <button class="btn btn-primary ladda-button"data-style="expand-right" type="button" id="btnProveedorGuardar">Guardar</button>
                                                                    <button type="button" class="btn btn-success" data-dismiss="modal" id="btnSalirProveedor">Salir</button>
                                                                </div>
                                                            </div> 
                                                            <!--BOTONES -->
