						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<a href="../grupocomer/crearGrupoCom">
									<button type="button" class="btn btn-primary"
									id="btningGrupoCom">Crear Grupo Comercial</button>
									</a>
<!-- 									<br/> -->
							<div class="row">
                                        			<div class= "container_fluid">
														...
														<br/>
					                                    <form method="GET" id="frm_filtrarGrupoCom" name="frm_filtrarGrupoCom" action="" novalidate>
					                                            <div class="row">
...
<!-- 					                                                        <legend>Filtros de Empresa</legend> -->
					                                                        ...
					                                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
					                                                            <div class="col-md-4 col-sm-6 col-xs-12 form-group">
					                                                                <label for="frmGCFiltroNombre" class="control-label">Grupo Comercial:</label>
					                                                                <input type="text" name="frmGCFiltroNombre" id="frmGCFiltroNombre" class="form-control input-sm filter-single" value="" maxlength="100">
					                                                            </div>
					                                                            <div class="col-md-4 col-sm-6 col-xs-12 form-group">
					                                                                <label for="frmGCFiltroEstado" class="control-label">Estado:</label>

					                                                                <select style="width:100%" class="form-control filter-single input-sm" id="frmGCFiltroEstado" name="frmGCFiltroEstado">
...
<!-- 					                                </div> -->
									...
									<table id="lstGrupoComer" name="lstGrupoComer"
...
<!-- 						</div> -->
		...
		<script src="<c:url value='../resources/v1/GrupoComercialController.js'/>"
