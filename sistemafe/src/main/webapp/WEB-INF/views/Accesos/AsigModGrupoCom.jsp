						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content"><input type="hidden"
												...
												<div class="x_panel">
													<div class="row">
														<div class="col-lg-12 col-md-12 col-xs-12 form-group">
															...
															<input type="text" class="form-control" id="grupocom_vname" name="grupocom_vname" placeholder="Nombres"  value="${nombreGrupoCom}" maxlength="100" readonly="readonly" />
														</div>
													</div>
													<div class="row">
														<div class="col-lg-12 col-md-12 col-xs-12 form-group">
													...
													<div class="row">
														<div class="col-lg-12 col-md-12 col-xs-12 form-group">
															...
															<textarea maxlength="250" id="grupocom_vdescrip" name="grupocom_vdescrip" class="form-control valid" rows="4" style="resize: none;" aria-invalid="false" readonly="readonly" ><c:out value="${descrGrupoCom}" /></textarea>
														</div>
													</div>
												</div>
											</div>
									...
									<%@include file="../../template/Accesos/confasigModGrupoCom.jsp"%>
