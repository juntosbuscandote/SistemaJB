...
//	@ApiModelProperty(value = "Numero de comprobante")
	...
	public String toString() {
		return "TSalesFilter [vnumbervoucher=" + vnumbervoucher + ", busiBident=" + busiBident + ", vbusiname_clie="
				+ vbusiname_clie + ", dresult_total=" + dresult_total + ", saleCstate=" + saleCstate + "]";
	}
