...
public class TSales {
	 ...
	 */
	// @ApiModelProperty(value = "total inafecto de resultados de venta de producto
	// o servicios")
	 ...
	 */
	// @ApiModelProperty(value = "total exonerada de resultados de venta de producto
	// o servicios")
	BigDecimal saleDexonerated;

	/**
	 * <strong>sale_dtaxed_bim numeric</strong><br>
	 * total gravado de base imponible en resultados de venta de producto o
	 * servicios
	 */
	// @ApiModelProperty(value = "total gravado de base imponible en resultados de
	 ...
	 */
	// @ApiModelProperty(value = "total exportacion en resultados de venta de
	 ...
	 */
	// @ApiModelProperty(value = "total monto de venta gratuita en resultados de
	// venta de producto o servicios")
	 ...
	 */
	// @ApiModelProperty(value = "total neto en resultados de venta de producto o
	// servicios")
	BigDecimal saleDnet;
	 ...
	 */
	// @ApiModelProperty(value = "total igv en resultados de venta de producto o
	// servicios")
	BigDecimal saleDigv;
	 ...
	 */
	// @ApiModelProperty(value = "total de descuento en resultados de venta de
	// producto o servicios")
	 ...
	 */
	// @ApiModelProperty(value = "total en resultados de venta de producto o
	// servicios")
	BigDecimal saleDtotal;

	/**
	 * <strong>sale_dconversion numeric</strong><br>
	 * total de conversion de moneda origen a destino en resultados de venta de
	 * producto o servicios
	 */
	// @ApiModelProperty(value = "total de conversion de moneda origen a destino en
	// resultados de venta de producto o servicios")
	 ...
	 */
	// @Size(max = 300)
	// @ApiModelProperty(value = "total monto en letras en resultados de venta de
	// producto o servicios")
	...
	String saleUrlPdf;
	// @ApiModelProperty(value = "Valor total en resultados de venta de producto o
	...
	String Sale_state_cash;
	String sale_destination;
	BigDecimal Sale_saldo_pending;
	// mtoledo 09/03/2019 CWA-591
	String saleTypeOperation; //tipo de operacion
	String saleTypeAnticipo; //tipo de anticipo
	BigDecimal saleTotalAnticipo;
	BigDecimal saleTotalDisponibleAnticipo;

	public String getSale_state_cash() {
		return Sale_state_cash;
	}

	public void setSale_state_cash(String sale_state_cash) {
		Sale_state_cash = sale_state_cash;
	}

	public String getSale_destination() {
		return sale_destination;
	}

	public void setSale_destination(String sale_destination) {
		this.sale_destination = sale_destination;
	}

	public BigDecimal getSale_saldo_pending() {
		return Sale_saldo_pending;
	}

	public void setSale_saldo_pending(BigDecimal sale_saldo_pending) {
		Sale_saldo_pending = sale_saldo_pending;
	}
	...
	public String getSaleTypeOperation() {
		return saleTypeOperation;
	}

	public void setSaleTypeOperation(String saleTypeOperation) {
		this.saleTypeOperation = saleTypeOperation;
	}

	public String getSaleTypeAnticipo() {
		return saleTypeAnticipo;
	}

	public void setSaleTypeAnticipo(String saleTypeAnticipo) {
		this.saleTypeAnticipo = saleTypeAnticipo;
	}

	
	public BigDecimal getSaleTotalAnticipo() {
		return saleTotalAnticipo;
	}

	public void setSaleTotalAnticipo(BigDecimal saleTotalAnticipo) {
		this.saleTotalAnticipo = saleTotalAnticipo;
	}

	public BigDecimal getSaleTotalDisponibleAnticipo() {
		return saleTotalDisponibleAnticipo;
	}

	public void setSaleTotalDisponibleAnticipo(BigDecimal saleTotalDisponibleAnticipo) {
		this.saleTotalDisponibleAnticipo = saleTotalDisponibleAnticipo;
	}
