...
public String toString() {
	return "TSeries [seriBident=" + seriBident + ", seriCdocElectronic=" + seriCdocElectronic + ", seriVtypeDoc="
			+ seriVtypeDoc + ", seriVnumberSeries=" + seriVnumberSeries + ", seriVhomologatedSerialNumb="
			+ seriVhomologatedSerialNumb + ", seriTregistratonDate=" + seriTregistratonDate + ", seriTdateUpdate="
			+ seriTdateUpdate + ", seriBuserCreate=" + seriBuserCreate + ", seriBuserModify=" + seriBuserModify
			+ ", busiBident=" + busiBident + "]";
}
